...
const CPU = () => {
    ...
    useEffect(() => {
        fetch(
            "https://raw.githubusercontent.com/actuallynotrena/switchblade-data/master/cpu.json"
        )
    ...
    _getItem = async (item) => {
        await AsyncStorage.setItem("CPU", JSON.stringify(item));
        Toast.show({
            type: "success",
        ...
        >
            <View style={{ maxWidth: "72%" }}>
                ...
                >
                    ...
                    {item.cpu_cores} {language.cpu_cores}{" "}
                    {item.price
                        ? "- " +
                          item.price +
    ...
    } else if (SearchText.startsWith("cores:")) {
        filteredData = data.filter((item) => {
            const cpu_cores = item.cpu_cores || "";
            if (SearchText.split(":")[1] == "") {
                return false;
            } else {
                return cpu_cores
        ...
        return (
            <SafeAreaProvider>
                ...
                >
                    ...
                    >
                        <HeaderText text={language.cpu_screen_header} />
                        <TouchableOpacity
                            onPress={() => {
                                navigation.navigate("CpuHelper");
                            }}
                        >
                            <Text
                                style={{
                    ...
                    >
                        <TouchableOpacity
                            onPress={() => setSearchText("cores:6")}
                        >
                            <TagComponent TagText="6 cores" />
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => setSearchText("cores:12")}
                        >
                            <TagComponent TagText="12 cores" />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => setSearchText("AMD")}>
                            <TagComponent TagText="AMD" />
                        </TouchableOpacity>
                        <TouchableOpacity
                        ...
                        <TouchableOpacity
                            onPress={() => setSearchText("AMD Ryzen 5")}
                        >
                            <TagComponent TagText="Ryzen 5" />
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => setSearchText("AMD Ryzen 7")}
                        >
                            <TagComponent TagText="Ryzen 7" />
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => setSearchText("Intel")}
                        >
                            <TagComponent TagText="Intel" />
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => setSearchText("Intel Core i5")}
                        >
                            <TagComponent TagText="Core i5" />
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => setSearchText("Intel Core i7")}
                        >
                            <TagComponent TagText="Core i7" />
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => setSearchText("Intel Core i9")}
                        >
                            <TagComponent TagText="Core i9" />
                        </TouchableOpacity>
                        <TouchableOpacity
